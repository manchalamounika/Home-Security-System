...
public class GenScheduleWindow extends JPanel{
	...
	public JPanel createProfileWindow() {
		...
		TableLView tv = new TableLView();
		String column[]={"SensorType","RoomName","StartTime","EndTime"};         

		DefaultTableModel dt = new DefaultTableModel(tv.genTable(), column);
		...
		scheduleSave.addActionListener(new ScheduleSetUpListener(this.twoColPanel,profilePanel, jBox, tempSensorChkBox, motionSensorChkBox,hourBox,minBox, ehourBox, eminBox,tv,dt));
